...
static const int cpu_millivolts[MAX_DVFS_FREQS] = {
	675, 700, 750, 775, 800, 812, 875,  900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1062, 1087};

static const unsigned int cpu_cold_offs_mhz[MAX_DVFS_FREQS] = {
	  50,  50,  50,  50,  50,  50,  50,  50,  50,   50,   50,   50,   50,   50,   50,   50,   50,   50};

static const int core_millivolts[MAX_DVFS_FREQS] = {
	875, 925, 975, 1025, 1050, 1100, 1150, 1200, 1250};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  416000,  416000,  416000,  416000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 416000, 484000,  520000,  520000,  520000,  520000),
	...
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 332000, 416000, 484000,  520000,  520000,  520000,  520000),
